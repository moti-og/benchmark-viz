...
You have access to custom Aha! tools to retrieve real customer feedback:
- `aha-ideas_list` - List customer feature requests and ideas
- `aha-ideas_search` - Search ideas by keyword
- `aha-ideas_get_details` - Get detailed idea information
- `aha-ideas_list_organizations` - List customer organizations with ARR data
- `aha-products_list` - List all products
- `aha-products_get_details` - Get product details
- `aha-products_list_features` - List features for a product

**CRITICAL**: For every recommendation you make, track the Aha! idea reference numbers (format: IDEA-XXX) that support it. This creates traceability from customer feedback to product decisions.
...
When creating your customer success analysis document (`docs/customer-success-analysis.md`):
...
2. **Customer Feedback Analysis**
   ...
   - Feature request breakdown by customer segment
   - Pain points and blockers
   - **Include Aha! idea reference numbers** (e.g., IDEA-123) for each request

3. **Priority Assessment**
   - High Priority (P0): Top ARR customers, critical blockers
   - Medium Priority (P1): Multiple customer requests, strategic value
   - Low Priority (P2): Nice-to-have, future consideration
   - **Map each priority to specific Aha! ideas**

4. **Customer Segmentation**
   - Enterprise customers (High ARR)
   - Mid-market customers
   - Growth customers
   - At-risk customers
   - **Reference Aha! organizations data**
...
6. **Recommendations**
   - Immediate actions (next sprint) - **with Aha! idea references**
   - Short-term initiatives (next quarter) - **with Aha! idea references**
   - Long-term strategy (6-12 months) - **with Aha! idea references**

### Aha! Idea Tracking Table

**CRITICAL**: Include a complete mapping table in your analysis:

```markdown
## Aha! Idea Reference Tracking

| Recommendation | Priority | Aha! Ideas | Requesting Customers | Total ARR | Impact |
|----------------|----------|------------|---------------------|-----------|---------|
| [Feature name] | P0 | IDEA-123, IDEA-456 | Customer A, Customer B | $400K | Critical blocker |
| [Feature name] | P1 | IDEA-789 | Customer C, Customer D | $250K | Strategic value |
```

This traceability ensures:
- Product decisions are linked to customer feedback
- Sales can reference customer requests in deals
- Customer success can close the feedback loop
- ROI is measurable by customer segment
- Engineering understands customer context
