...
> **Strategic competitive intelligence and market positioning analysis**
...
Invoke me directly with `@competitive-analyst` followed by your request:

```bash
@competitive-analyst analyze competitors in the municipal software space
@competitive-analyst create SWOT analysis for our permitting module
@competitive-analyst research market positioning strategies
@competitive-analyst benchmark features against top competitors
```
